...
export default function HeroSection() {
  return (
    <section className="page-hero md:min-h-[60vh] flex items-center relative overflow-hidden bg-white">
      ...
      <div className="relative container-wide w-full py-6 sm:py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-14 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.12] tracking-tight mb-4 sm:mb-5 text-gray-900">
              Fysiotherapie<br />
              Schipluiden
            </h1>
            <p className="text-base text-gray-700 leading-relaxed mb-6 sm:mb-8 max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                href="/contact"
                className="bg-primary text-white px-6 py-3.5 text-sm font-semibold rounded-full hover:bg-primary/90 transition-all duration-200 shadow-md hover:shadow-lg text-center min-h-11 flex items-center justify-center touch-manipulation w-full sm:w-auto"
              >
                Maak een afspraak
              </Link>
              <Link
            ...
            <div className="mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-gray-200">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-3">
                <div className="flex justify-center sm:justify-start sm:pr-3 lg:pr-4">
                  <GoogleRatingBadge size="sm" />
                </div>
                <div className="flex flex-col justify-center gap-1 leading-none text-center sm:text-left sm:border-l sm:border-gray-200 sm:pl-3 lg:pl-4">
          ...
          <div className="order-3 lg:order-2 relative">
            <div className="relative rounded-3xl overflow-hidden glow-primary shadow-xl">
              <Image
                ...
                className="w-full h-[260px] sm:h-[320px] md:h-[400px] lg:h-[480px] object-cover object-[50%_20%]"
              />
            </div>
          </div>
        </div>
